...
student1 = Student('Itan', 'Hunt', 'm')
student1.courses_inprogress += ['Java', 'SQL', 'Cooking']
student2 = Student('Jaina', 'Proudmoore', 'f')
student2.courses_inprogress += ['Python', 'SQL', 'C++', 'Java']
student3 = Student('Ivan', 'Ivanov', 'm')

lecturer1 = Lecturer('Arthas', 'Menethil')
lecturer2 = Lecturer('Malfurion', 'Stormrage')
lecturer1.courses_attached += ['Python', 'Java', 'C++']
lecturer2.courses_attached += ['C++', 'Cooking', 'SQL']

reviewer1 = Reviewer('Jhon', 'Snow')
reviewer2 = Reviewer('Daenerys', 'Targaryen')
reviewer1.courses_attached += ['Java', 'Cooking', 'SQL']
...
student1.rate_lecturer(lecturer2, 'Cooking', 7)
...
student2.rate_lecturer(lecturer1, 'C++', 9)

reviewer1.rate_hw(student1, 'Java', 7)
reviewer1.rate_hw(student1, 'Cooking', 10)
reviewer2.rate_hw(student1, 'SQL', 8)
reviewer1.rate_hw(student2, 'SQL', 9)
